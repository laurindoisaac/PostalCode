// src/lib.rs
/*
 * Core library for PostalCodeLookup
 */
...
#[derive(Debug)]
pub struct PostalCodeLookupProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PostalCodeLookupProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PostalCodeLookup processing");
    
    let mut processor = PostalCodeLookupProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PostalCodeLookupProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PostalCodeLookupProcessor::new(false);
